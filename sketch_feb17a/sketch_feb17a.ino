...
const char* ssid = "tiktak"; //type your WIFI information inside the quotes
const char* password = "Dat1sh3m!";
const char* mqtt_server = "10.0.0.5";
const char* mqtt_username = "hassio";
const char* mqtt_password = "Villavandalen2019";
const int mqtt_port = 1883;



/**************************** FOR OTA **************************************************/
#define SENSORNAME "dev1" //change this to whatever you want to call your device
...
const char* light_state_topic = "bruh/dev1";
const char* light_set_topic = "bruh/dev1/set";
